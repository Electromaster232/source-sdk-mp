...
struct CBaseGameSystem_wrapper : CBaseGameSystem, bp::wrapper< CBaseGameSystem > {
    ...
    virtual void LevelShutdownPreClearSteamAPIContext(  ) {
        PY_OVERRIDE_CHECK( CBaseGameSystem, LevelShutdownPreClearSteamAPIContext )
        PY_OVERRIDE_LOG( _gameinterface, CBaseGameSystem, LevelShutdownPreClearSteamAPIContext )
...
struct CBaseGameSystemPerFrame_wrapper : CBaseGameSystemPerFrame, bp::wrapper< CBaseGameSystemPerFrame > {
    ...
    virtual void LevelShutdownPreClearSteamAPIContext(  ) {
        PY_OVERRIDE_CHECK( CBaseGameSystemPerFrame, LevelShutdownPreClearSteamAPIContext )
        PY_OVERRIDE_LOG( _gameinterface, CBaseGameSystemPerFrame, LevelShutdownPreClearSteamAPIContext )
        bp::override func_LevelShutdownPreClearSteamAPIContext = this->get_override( "LevelShutdownPreClearSteamAPIContext" );
        if( func_LevelShutdownPreClearSteamAPIContext.ptr() != Py_None )
            try {
                func_LevelShutdownPreClearSteamAPIContext(  );
...
BOOST_PYTHON_MODULE(_gameinterface){
    ...
    { //::ConVarRef
        ...
        { //::ConVarRef::GetMax
            ...
            typedef bool ( ::ConVarRef::*GetMax_function_type)( float & ) const;
            
            ConVarRef_exposer.def( 
                "GetMax"
                , GetMax_function_type( &::ConVarRef::GetMax )
                , ( bp::arg("maxVal") ) );
        
        }
        { //::ConVarRef::GetMin
        
            typedef bool ( ::ConVarRef::*GetMin_function_type)( float & ) const;
            
            ConVarRef_exposer.def( 
                "GetMin"
                , GetMin_function_type( &::ConVarRef::GetMin )
                , ( bp::arg("minVal") ) );
