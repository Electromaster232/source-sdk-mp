...
struct C_BaseEntity_wrapper : C_BaseEntity, bp::wrapper< C_BaseEntity > {
    ...
    static boost::python::object EmitSound_e4b4762fb9358ec88c05ad458fc7366a( ::C_BaseEntity & inst, char const * soundname, float soundtime=0.F ){
        float duration2;
        inst.EmitSound(soundname, soundtime, &duration2);
        return bp::object( duration2 );
    }

    static boost::python::object EmitSound_1c0070052e1719f9897ee4d384fcdef1( ::C_BaseEntity & inst, char const * soundname, ::HSOUNDSCRIPTHANDLE & handle, float soundtime=0.F ){
        float duration2;
        inst.EmitSound(soundname, handle, soundtime, &duration2);
        return bp::object( duration2 );
    }

    static boost::python::object EmitSound_1c0216bc9705244e7b64bf26248f7984( ::IRecipientFilter & filter, int iEntIndex, char const * soundname, ::Vector const * pOrigin=0, float soundtime=0.F ){
        float duration2;
        ::C_BaseEntity::EmitSound(filter, iEntIndex, soundname, pOrigin, soundtime, &duration2);
        return bp::object( duration2 );
    }

    static boost::python::object EmitSound_271ec8a657e8e0cf447432d88c77c306( ::IRecipientFilter & filter, int iEntIndex, char const * soundname, ::HSOUNDSCRIPTHANDLE & handle, ::Vector const * pOrigin=0, float soundtime=0.F ){
        float duration2;
    ...
    static boost::python::tuple GetShadowCastDistance( ::C_BaseEntity const & inst, ::ShadowType_t shadowType ){
        float pDist2;
        bool result = inst.GetShadowCastDistance(&pDist2, shadowType);
        return bp::make_tuple( result, pDist2 );
    }
    ...
    static int m_lifeState_Get( C_BaseEntity const & inst ) { return inst.m_lifeState; }

    static void m_lifeState_Set( C_BaseEntity & inst, int val ) { inst.m_lifeState = val; }

    static int m_takedamage_Get( C_BaseEntity const & inst ) { return inst.m_takedamage; }

    static void m_takedamage_Set( C_BaseEntity & inst, int val ) { inst.m_takedamage = val; }
...
void register_C_BaseEntity_class(){
    ...
    { //::C_BaseEntity
        ...
        { //::C_BaseEntity::GetShadowCastDistance
            ...
            typedef boost::python::tuple ( *GetShadowCastDistance_function_type )( ::C_BaseEntity const &,::ShadowType_t );
            
            C_BaseEntity_exposer.def( 
                "GetShadowCastDistance"
                , GetShadowCastDistance_function_type( &C_BaseEntity_wrapper::GetShadowCastDistance )
                , ( bp::arg("inst"), bp::arg("shadowType") ) );
        ...
        { //::C_BaseEntity::ResolveFlyCollisionBounce
            ...
            C_BaseEntity_exposer.def( 
                ...
                , ( bp::arg("trace"), bp::arg("vecVelocity"), bp::arg("flMinTotalElasticity")=0.F ) );
        ...
        { //::C_BaseEntity::Restore
            ...
            typedef int ( C_BaseEntity_wrapper::*default_Restore_function_type)( ::IRestore & ) ;
            
            C_BaseEntity_exposer.def( 
                "Restore"
                , Restore_function_type(&::C_BaseEntity::Restore)
                , default_Restore_function_type(&C_BaseEntity_wrapper::default_Restore)
                , ( bp::arg("restore") ) );
        ...
        { //::C_BaseEntity::VPhysicsGetObject
        
            typedef ::IPhysicsObject * ( ::C_BaseEntity::*VPhysicsGetObject_function_type)(  ) const;
            
            C_BaseEntity_exposer.def( 
                "VPhysicsGetObject"
                , VPhysicsGetObject_function_type( &::C_BaseEntity::VPhysicsGetObject )
                , bp::return_value_policy< bp::return_by_value >() );
        
        }
        { //::C_BaseEntity::VPhysicsInitNormal
        
            typedef ::IPhysicsObject * ( ::C_BaseEntity::*VPhysicsInitNormal_function_type)( ::SolidType_t,int,bool,::solid_t * ) ;
            
            C_BaseEntity_exposer.def( 
                "VPhysicsInitNormal"
                , VPhysicsInitNormal_function_type( &::C_BaseEntity::VPhysicsInitNormal )
        ...
        { //::C_BaseEntity::VPhysicsInitShadow
            ...
            typedef ::IPhysicsObject * ( ::C_BaseEntity::*VPhysicsInitShadow_function_type)( bool,bool,::solid_t * ) ;
            
            C_BaseEntity_exposer.def( 
                "VPhysicsInitShadow"
                , VPhysicsInitShadow_function_type( &::C_BaseEntity::VPhysicsInitShadow )
                , ( bp::arg("allowPhysicsMovement"), bp::arg("allowPhysicsRotation"), bp::arg("pSolid")=bp::object() )
                , bp::return_value_policy< bp::return_by_value >() );
        
        }
        { //::C_BaseEntity::VPhysicsInitStatic
        
            typedef ::IPhysicsObject * ( ::C_BaseEntity::*VPhysicsInitStatic_function_type)(  ) ;
            
            C_BaseEntity_exposer.def( 
                "VPhysicsInitStatic"
                , VPhysicsInitStatic_function_type( &::C_BaseEntity::VPhysicsInitStatic )
                , bp::return_value_policy< bp::return_by_value >() );
        ...
        C_BaseEntity_exposer.def_readwrite( "clrender", &C_BaseEntity::m_clrRender );
        ...
        C_BaseEntity_exposer.def_readwrite( "renderfx", &C_BaseEntity::m_nRenderFX );
        C_BaseEntity_exposer.def_readwrite( "renderfxblend", &C_BaseEntity::m_nRenderFXBlend );
