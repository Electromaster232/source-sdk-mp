...
ConVar gameinstructor_verbose(
	"gameinstructor_verbose", "1", FCVAR_CHEAT,
...
ConVar gameinstructor_find_errors(
	"gameinstructor_find_errors", "1", FCVAR_CHEAT,
...
ConVar gameinstructor_enable("gameinstructor_enable", "1", FCVAR_CLIENTDLL | FCVAR_ARCHIVE,
	"Display in game lessons that teach new players.", GameInstructorEnable_ChangeCallback);
...
ConVar sv_gameinstructor_disable("sv_gameinstructor_disable", "0", FCVAR_REPLICATED,
	"Force all clients to disable their game instructors.",
	SVGameInstructorDisable_ChangeCallback);
