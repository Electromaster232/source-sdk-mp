...
// My Portals
CLIENTEFFECT_MATERIAL("newportals/group2/blue/portal_dynamicmesh")
CLIENTEFFECT_MATERIAL("newportals/group2/red/portal_dynamicmesh")
CLIENTEFFECT_MATERIAL("newportals/group2/blue/portal_renderfix_dynamicmesh")
CLIENTEFFECT_MATERIAL("newportals/group2/red/portal_renderfix_dynamicmesh")
#endif
// Static
...
// My Portals
CLIENTEFFECT_MATERIAL("newportals/group2/blue/portalstaticoverlay")
CLIENTEFFECT_MATERIAL("newportals/group2/blue/portal_refract")
CLIENTEFFECT_MATERIAL("newportals/group2/red/portalstaticoverlay")
CLIENTEFFECT_MATERIAL("newportals/group2/red/portal_refract")
...
public:
	...
	void LevelInitPreEntity()
	{
		...
		// Original blue/orange portals-- VPK packed in materials/models directory
		m_Materials.m_PortalMaterials[0][0].Init( "models/portals/portal_1_dynamicmesh", TEXTURE_GROUP_CLIENT_EFFECTS );
		m_Materials.m_PortalMaterials[0][1].Init( "models/portals/portal_2_dynamicmesh", TEXTURE_GROUP_CLIENT_EFFECTS );
		m_Materials.m_PortalRenderFixMaterials[0][0].Init( "models/portals/portal_1_renderfix_dynamicmesh", TEXTURE_GROUP_CLIENT_EFFECTS );
		m_Materials.m_PortalRenderFixMaterials[0][1].Init( "models/portals/portal_2_renderfix_dynamicmesh", TEXTURE_GROUP_CLIENT_EFFECTS );
		m_Materials.m_PortalStaticOverlay[0][0].Init( "models/portals/portalstaticoverlay_1", TEXTURE_GROUP_CLIENT_EFFECTS );
		m_Materials.m_PortalStaticOverlay[0][1].Init( "models/portals/portalstaticoverlay_2", TEXTURE_GROUP_CLIENT_EFFECTS );
		m_Materials.m_Portal_Refract[0][0].Init("models/portals/portal_refract_1", TEXTURE_GROUP_CLIENT_EFFECTS);
		m_Materials.m_Portal_Refract[0][1].Init("models/portals/portal_refract_2", TEXTURE_GROUP_CLIENT_EFFECTS);

		// My Portals Set 1 -- materials/newportals/group2
		m_Materials.m_PortalMaterials[1][0].Init("newportals/group2/blue/portal_dynamicmesh", TEXTURE_GROUP_CLIENT_EFFECTS);
		m_Materials.m_PortalMaterials[1][1].Init("newportals/group2/red/portal_dynamicmesh", TEXTURE_GROUP_CLIENT_EFFECTS);
		m_Materials.m_PortalRenderFixMaterials[1][0].Init("newportals/group2/blue/portal_renderfix_dynamicmesh", TEXTURE_GROUP_CLIENT_EFFECTS);
		m_Materials.m_PortalRenderFixMaterials[1][1].Init("newportals/group2/red/portal_renderfix_dynamicmesh", TEXTURE_GROUP_CLIENT_EFFECTS);
		m_Materials.m_PortalStaticOverlay[1][0].Init("newportals/group2/blue/portalstaticoverlay", TEXTURE_GROUP_CLIENT_EFFECTS);
		m_Materials.m_PortalStaticOverlay[1][1].Init("newportals/group2/red/portalstaticoverlay", TEXTURE_GROUP_CLIENT_EFFECTS);
		m_Materials.m_Portal_Refract[1][0].Init("newportals/group2/blue/portal_refract", TEXTURE_GROUP_CLIENT_EFFECTS);
		m_Materials.m_Portal_Refract[1][1].Init("newportals/group2/red/portal_refract", TEXTURE_GROUP_CLIENT_EFFECTS);


		// Static files for all portals
...
CPortalRenderable_FlatBasic::CPortalRenderable_FlatBasic(void)
	...
	m_bIsPortal2(false)
{
	portalGroupId = (ConVarRef("currentPortalId")).GetInt();
...
void CPortalRenderable_FlatBasic::DrawPreStencilMask( void )
{
	...
	{
		DrawSimplePortalMesh( m_Materials.m_Portal_Refract[portalGroupId - 1][ ( ( m_bIsPortal2 ) ? ( 1 ) : ( 0 ) ) ] );
	}
}
...
void CPortalRenderable_FlatBasic::DrawComplexPortalMesh( const IMaterial *pMaterialOverride, float fForwardOffsetModifier ) //generates and draws the portal mesh (Needed for compatibility with fixed function rendering)
{
	...
	{
		pMaterial = m_Materials.m_PortalMaterials[portalGroupId - 1][(m_bIsPortal2)?1:0];
	}
...
void CPortalRenderable_FlatBasic::DrawRenderFixMesh( const IMaterial *pMaterialOverride, float fFrontClipDistance )
{
	...
	if( pMaterialOverride )
		...
		pMaterial = m_Materials.m_PortalRenderFixMaterials[portalGroupId-1][(m_bIsPortal2)?1:0];
...
void CPortalRenderable_FlatBasic::DrawPortal( void )
{
	...
	if ( g_pPortalRender->ShouldUseStencilsToRenderPortals() )
	{
		...
		if( g_pPortalRender->IsRenderingPortal() == false ) //main view
		{
			...
			DrawSimplePortalMesh( m_Materials.m_PortalStaticOverlay[portalGroupId - 1][((m_bIsPortal2)?(1):(0))] );
			DrawRenderFixMesh( g_pPortalRender->m_MaterialsAccess.m_WriteZ_Model );
		}
	...
	else
	{
		...
		else if( g_pPortalRender->GetCurrentViewExitPortal() != this ) //don't render portals that our view is exiting from
		{
			...
			DrawSimplePortalMesh( m_Materials.m_PortalStaticOverlay[portalGroupId - 1][((m_bIsPortal2)?(1):(0))] ); //FIXME: find out why the projection mesh screws up at the second level of rendering in -nouserclip situations
		}
