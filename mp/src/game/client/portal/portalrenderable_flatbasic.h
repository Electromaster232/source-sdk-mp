...
{
	CMaterialReference	m_PortalMaterials[2][2];
	CMaterialReference	m_PortalRenderFixMaterials[2][2];
	CMaterialReference	m_PortalDepthDoubler;
	CMaterialReference	m_PortalStaticOverlay[2][2];
	CMaterialReference	m_Portal_Stencil_Hole;
	CMaterialReference	m_Portal_Refract[2][2];
