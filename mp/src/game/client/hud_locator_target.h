...
public:
	...
	CGameInstructorSymbol(const char *pStr);
	CGameInstructorSymbol &operator=(CGameInstructorSymbol const &src);
	bool operator==(CGameInstructorSymbol const &src) const;
	const char *String() const;

private:
	CUtlSymbol m_SymbolId;
};
static CUtlSymbolTable g_CGameInstructorSymbolSymbolTable;
    CGameInstructorSymbol::CGameInstructorSymbol()                                                                                              
    {                                                                                                                  
        m_SymbolId = UTL_INVAL_SYMBOL;                                                                                 
    }                                                                                                                  
    CGameInstructorSymbol   ::CGameInstructorSymbol (const char *pStr)                                                                              
    {                                                                                                                  
        m_SymbolId = g_CGameInstructorSymbolSymbolTable.AddString(pStr);                                                        
    }                                                                                                                  
    CGameInstructorSymbol  &CGameInstructorSymbol ::operator=(CGameInstructorSymbol const &src)                                                                
    {                                                                                                                  
        m_SymbolId = src.m_SymbolId;                                                                                   
        return *this;                                                                                                  
    }                                                                                                                  
    bool CGameInstructorSymbol ::operator==(CGameInstructorSymbol const &src) const                                                              
    {                                                                                                                  
        return (m_SymbolId == src.m_SymbolId);                                                                         
    }                                                                                                                  
    const char *CGameInstructorSymbol ::String() const                                                                              
    {                                                                                                                  
        return g_CGameInstructorSymbolSymbolTable.String(m_SymbolId);                                                           
    }
	*/
//-----------------------------------------------------------------------------
